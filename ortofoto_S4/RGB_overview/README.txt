Visor de ortofoto: seccion4
Generado: 2026-09-11T10:43:41-0600
Origen:   F:\INYDES\Vuelos\Seccion4\Ortomosaico\s4\Ortomosaico_Seccion_4.tif

ESTRUCTURA
----------
F:\geoportal_chapultepec\visor_web_export\ortofoto_S4\RGB_overview/
...
2) Servidor local (recomendado):
     cd F:\geoportal_chapultepec\visor_web_export\ortofoto_S4\RGB_overview
...
4) Name:     seccion4
5) Attribution: Orto UAV INyDES 2026 S4 RGB - overview 50cm/px
6) Max zoom: 17
...
En FastAPI (visor_fa/app.py) montar la carpeta /tiles como estatico:
    ...
    app.mount("/ortofoto", StaticFiles(directory=r"F:\geoportal_chapultepec\visor_web_export\ortofoto_S4\RGB_overview"))
Y en el HTML del visor:
    L.tileLayer('/ortofoto/tiles/{z}/{x}/{y}.png', { attribution: 'Orto UAV INyDES 2026 S4 RGB - overview 50cm/px' })
...
LICENCIA / ATRIBUCION
---------------------
Atribucion obligatoria: Orto UAV INyDES 2026 S4 RGB - overview 50cm/px
