Visor de ortofoto: 🌿 VARI Parque Libano (S1)
Generado: 2026-09-09T17:22:41-0600
Origen:   F:\INYDES\Vuelos\seccion1\Ortomosaico_P_Líbano_Peri_Memorial\Ortofoto seccion 1 parque-VARI.tif

ESTRUCTURA
----------
ortofoto_S1\Parque_Ortofotoseccion1parqueVARI/
...
2) Servidor local (recomendado):
     cd ortofoto_S1\Parque_Ortofotoseccion1parqueVARI
...
En FastAPI (visor_fa/app.py) montar la carpeta /tiles como estatico:
    ...
    app.mount("/ortofoto", StaticFiles(directory=r"ortofoto_S1\Parque_Ortofotoseccion1parqueVARI"))
